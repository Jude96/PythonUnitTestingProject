...
withdrawToOwnNumber: true

output:- signature: "X28HKTx6A7wgM1yLh21ZYXxFIH1EZIyG1iLvWPPzjOQ="
...
def create_transaction_signature(reference, input_string):
    # Step 4: Generate the final HMAC signature
...
def generate_hmac_signature(input_string, reference):
    # Step 3: Create the HMAC signature using SHA-256 and return it
...
def generate_signature(signature_object, reference):
    ...
    signature = '&'.join(str(value) for value in signature_object.values())
